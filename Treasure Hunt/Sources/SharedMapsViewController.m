...
- (void)viewDidLoad
{
    ...
    if ([self.searchDisplayController respondsToSelector:@selector(setDisplaysSearchBarInNavigationBar:)]) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	if (tableView == self.searchDisplayController.searchResultsTableView) {
        ...
        UIColor *tintColor = [UIColor colorWithRed:140/255.0f green:70/255.0f blue:35/255.0f alpha:0.5f];
...
{
    cell.backgroundColor = [UIColor colorWithWhite:1.0f alpha:.2f];
    cell.contentView.backgroundColor = [UIColor clearColor];
    cell.textLabel.backgroundColor = [UIColor clearColor];
    cell.textLabel.textColor = [UIColor colorWithWhite:0.0f alpha:.8f];
    cell.detailTextLabel.textColor = [UIColor colorWithWhite:0.0f alpha:.5f];
