...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    LeftTableViewController *leftTableVC = [[LeftTableViewController alloc] initWithNibName:nil bundle:nil];
    UINavigationController *leftNavController = [[UINavigationController alloc] initWithRootViewController:leftTableVC];
    
    RightDetailViewController *rightDetailVC = [[RightDetailViewController alloc] initWithNibName:nil bundle:nil];
    UINavigationController *rightNavController = [[UINavigationController alloc] initWithRootViewController:rightDetailVC];
    
    [leftTableVC setDelegate:rightDetailVC];
    
    _splitViewController = [[UISplitViewController alloc] init];
    NSArray *viewControllers = [[NSArray alloc] initWithObjects:leftNavController, rightNavController, nil];
    
    [_splitViewController setViewControllers:viewControllers];
    [_splitViewController setDelegate:rightDetailVC];
