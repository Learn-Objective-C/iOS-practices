...
class RefreshView: UIView, UIScrollViewDelegate {
    ...
    func beginRefreshing() {
        ...
        let airplaneOrientationRotation = CABasicAnimation(keyPath: "transform.rotation")
        airplaneOrientationRotation.fromValue = 0
        airplaneOrientationRotation.toValue = 4 * M_PI

        let flightAnimationGroup = CAAnimationGroup()
        flightAnimationGroup.duration = 1.5
        flightAnimationGroup.repeatDuration = 5.0
        flightAnimationGroup.animations = [flightAnimation, airplaneOrientationRotation]
